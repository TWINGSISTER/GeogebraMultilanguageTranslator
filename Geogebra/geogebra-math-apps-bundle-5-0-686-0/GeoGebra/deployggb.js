...
if (typeof window.web3d !== "function") {
    window.web3d = GGBAppletUtils.makeModule("web3d",'B537EE22305FD8C1192A92802F7EC40B');
}
if (typeof window.webSimple !== "function") {
    window.webSimple = GGBAppletUtils.makeModule("webSimple",'F8DF37D144649C2D6CC8DA01AE9351C9');
}
