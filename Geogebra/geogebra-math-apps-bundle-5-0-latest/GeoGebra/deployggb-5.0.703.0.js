...
var GGBApplet = function() {
    ...
    var setDefaultHTML5CodebaseForVersion = function(version, offline) {
        ...
        if (index > 0) {
            ...
            codebase = "https://www.geogebra.org/apps/5.0.703.0/";
        }
...
GGBAppletUtils.makeModule = function(name, permutation){
    function webModule() {
        ...
        B();
        webModule.__moduleBase = "https://www.geogebra.org/apps/5.0.703.0/" + name + "/";
...
if (typeof window.web3d !== "function") {
    window.web3d = GGBAppletUtils.makeModule("web3d",'EBCA0F4E6D7980DA6E66FE6381568022');
}
if (typeof window.webSimple !== "function") {
    window.webSimple = GGBAppletUtils.makeModule("webSimple",'67FABDC544551FC60B3AF5DA4F6075F1');
}
