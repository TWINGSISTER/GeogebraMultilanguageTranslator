...
var GGBApplet = function() {
    ...
    var setDefaultHTML5CodebaseForVersion = function(version, offline) {
        ...
        if (index > 0) {
            ...
            codebase = "https://www.geogebra.org/apps/5.0.720.0/";
        }
...
GGBAppletUtils.makeModule = function(name, permutation){
    function webModule() {
        ...
        B();
        webModule.__moduleBase = "https://www.geogebra.org/apps/5.0.720.0/" + name + "/";
...
if (typeof window.web3d !== "function") {
    window.web3d = GGBAppletUtils.makeModule("web3d",'E66A5C63E5780DE9C216B418BB557CE6');
}
if (typeof window.webSimple !== "function") {
    window.webSimple = GGBAppletUtils.makeModule("webSimple",'515E80DA61117123D2A78F6CF6F9605C');
}
