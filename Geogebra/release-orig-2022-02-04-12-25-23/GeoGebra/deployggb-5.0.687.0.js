...
var GGBApplet = function() {
    ...
    var setDefaultHTML5CodebaseForVersion = function(version, offline) {
        ...
        if (index > 0) {
            ...
            codebase = "https://www.geogebra.org/apps/5.0.687.0/";
        }
...
GGBAppletUtils.makeModule = function(name, permutation){
    function webModule() {
        ...
        B();
        webModule.__moduleBase = "https://www.geogebra.org/apps/5.0.687.0/" + name + "/";
...
if (typeof window.web3d !== "function") {
    window.web3d = GGBAppletUtils.makeModule("web3d",'7C71FEED25EABB466B97D0DCC1B78222');
}
if (typeof window.webSimple !== "function") {
    window.webSimple = GGBAppletUtils.makeModule("webSimple",'825017EE390D4539B68CC3D547D1823B');
}
